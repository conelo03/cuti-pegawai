  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('edit-izin/'. $izin['izin_id']);?>" method="post">
              <div class="card-header">
                <h4>Form Edit Pengajuan Izin Keluar Kantor</h4>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group">
                      ...
                      <input type="date" name="izin_tanggal" class="form-control" value="<?= set_value('izin_tanggal', $izin['izin_tanggal']) ?>">
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      <label>Mulai</label>
                      <input type="text" name="izin_mulai" class="form-control" value="<?= set_value('izin_mulai', $izin['izin_mulai'])?>">
                  ...
                  <div class="col-4">
                    <div class="form-group">
                      <label>Selesai</label>
                      <input type="text" name="izin_selesai" class="form-control" value="<?= set_value('izin_selesai', $izin['izin_selesai'])?>">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="izin_alasan" class="form-control" value="<?= set_value('izin_alasan', $izin['izin_alasan'])?>">
