  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-jabatan'); ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Jabatan</label>
                  <input type="text" name="jabatan_nama" class="form-control" value="<?= set_value('jabatan_nama'); ?>" required="">
                  <?= form_error('jabatan_nama', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Atasan Langsung</label>
                  <input type="text" name="jabatan_atasanlangsung" class="form-control" value="<?= set_value('jabatan_atasanlangsung'); ?>" required="">
