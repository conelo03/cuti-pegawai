  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Golongan</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-golruang'); ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="golruang_golongan" class="form-control" value="<?= set_value('golruang_golongan'); ?>" required="">
                  <?= form_error('golruang_golongan', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Ruangan</label>
                  <input type="text" name="golruang_ruang" class="form-control" value="<?= set_value('golruang_ruang'); ?>" required="">
                  <?= form_error('golruang_ruang', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Pangkat</label>
                  <input type="text" name="golruang_pangkat" class="form-control" value="<?= set_value('golruang_pangkat'); ?>" required="">
