  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-riwayat-cuti/'.$pegawai['pegawai_id']);?>" method="post">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="riwayat_cuti_tahun" class="form-control" placeholder="Tahun, ex : 2020" required> 
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <label>Sisa</label>
                      <input type="text" name="riwayat_cuti_sisa" class="form-control" required> 
